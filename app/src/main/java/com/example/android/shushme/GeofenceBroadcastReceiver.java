...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // COMPLETED Use GeofencingEvent.fromIntent to retrieve the GeofencingEvent that caused the transition
        ...
        // COMPLETED Call getGeofenceTransition to get the transition type and use AudioManager to set the
        ...
        // COMPLETED Show a notification to alert the user that the ringer mode has changed.
